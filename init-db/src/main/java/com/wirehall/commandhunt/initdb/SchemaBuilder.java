...
public class SchemaBuilder {
    ...
    public static void load(final JanusGraph graph) throws InterruptedException {
        ...
        String indexBackend = graph.configuration().getString("index." + INDEX_NAME + ".backend");
        ...
        if (indexBackend != null && !indexBackend.trim().isEmpty()) {
    ...
    private static void createCompositeIndexes(JanusGraph graph) throws InterruptedException {
        ...
        management.buildIndex("commandnameindex", Vertex.class).addKey(management.getPropertyKey("name"))
    ...
    private static void createMixedIndexes(JanusGraph graph) throws InterruptedException {
        ...
        management
                ...
                .addKey(management.getPropertyKey("name"))
                .addKey(management.getPropertyKey("desc"))
                .addKey(management.getPropertyKey("long_desc"))
                .buildMixedIndex(INDEX_NAME);
        management.commit();
